...
<nav
  className="relative flex w-full items-center justify-end bg-white py-2 text-neutral-600  hover:text-neutral-700 focus:text-neutral-700 dark:bg-neutral-600 dark:text-neutral-200 md:flex-wrap md:justify-end"
  data-te-navbar-ref>
